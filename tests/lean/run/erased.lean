...
trace: [Compiler.result] size: 6
    def _eval._lam_0 (_x.1 : Array
      ...
      cases _x.10 : EStateM.Result Lean.Exception lcAny PUnit
      | EStateM.Result.ok (a.11 : PUnit) (a.12 : lcAny) =>
        let _x.13 : EStateM.Result Lean.Exception lcAny PUnit := EStateM.Result.ok Lean.Exception lcAny PUnit _x.2 a.12;
        return _x.13
      | EStateM.Result.error (a.14 : Lean.Exception) (a.15 : lcAny) =>
        let _x.16 : EStateM.Result Lean.Exception lcAny
          PUnit := EStateM.Result.error Lean.Exception lcAny PUnit a.14 a.15;
        return _x.16
...
[Compiler.result] size: 9
    def _eval (a.1 : Lean.Elab.Command.Context) (a.2 : lcAny) (a.3 : PUnit) : EStateM.Result Lean.Exception PUnit
      ...
      let _x.12 : EStateM.Result Lean.Exception lcAny
