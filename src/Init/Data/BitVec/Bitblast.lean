...
#check Int.tdiv_nonpos_of_nonneg_of_nonpos
-- #check Int.tdiv_nonneg_of_nonpos_of_nonpos
-- #check Int.tdiv_nonpos_of_nonneg_of_nonpos
-- #check Int.tdiv_nonneg_of_nonpos_of_nonpos
#check Int.tdiv_
#check Int.eq_negSucc_of_natAbs_lt

theorem Int.tdiv_eq_zero_of_natAbs_lt {a : Int} {b : Nat}
    (hab : a.natAbs < b) : a.tdiv b = 0 := by
  by_cases h : a < 0
  · have := Int.eq_negSucc_of_natAbs_lt (by simp [h])
    rw [this]
    have := Int.tdiv_neg
    simp [this, Nat.lt_succ_iff, Nat.succ_le_iff] at hab
        ...
        · rw [msb_eq_toInt, msb_eq_toInt]
          ...
          · by_cases hy :  0 ≤ y.toInt
            ...
            · simp [show x.toInt < 0 by omega]
              ...
              apply Int.tdiv_nonneg_of_nonpos_of_nonpos <;> omega
